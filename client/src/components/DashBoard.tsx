        ...
        <div className="lg:w-[15%] bg-white flex flex-col gap-5 h-full">
          <div className="h-[15%] flex justify-around  items-center gap-2 border-b-2 border-black">
            <div className="flex justify-center items-center ">
              <h1 className="text-lg font-bold flex justify-center items-center gap-2"><FaUser /> {data?.firstName} {data?.lastName}</h1>
            </div>
            <div className="flex justify-center items-center">
          ...
          <div className="h-[85%] flex flex-col  gap-5 ">
            ...
            <div>
              <Button2 text="Add Todo" compo={<IoIosAddCircleOutline />} />
            </div>

            <div>
              <Button2 text="Completed Todo" compo={<MdOutlineIncompleteCircle />} />
            </div>
          </div>
        </div>
